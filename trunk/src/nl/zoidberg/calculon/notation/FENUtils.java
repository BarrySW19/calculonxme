...
public class FENUtils {
	...
	public static String generate(BitBoard board) {
		return generate(new Board(board));
	}
	...
	public static BitBoard getBitBoard(String fen) {
		return getBoard(fen).getBitBoard();
	}
	...
	public static String convertStyle12(Vector fields) {
		StringBuffer fen = new StringBuffer();
		for(int i = 0; i < 8; i++) {
			int eCount = 0;
			String line = (String) fields.elementAt(i + 1);
		...
		fen.append(" ").append(((String)fields.elementAt(9)).toLowerCase()).append(" ");
		StringBuffer buf = new StringBuffer();
		if("1".equals(fields.elementAt(11))) {
			buf.append("K");
		}
		if("1".equals(fields.elementAt(12))) {
			buf.append("Q");
		}
		if("1".equals(fields.elementAt(13))) {
			buf.append("k");
		}
		if("1".equals(fields.elementAt(14))) {
			buf.append("q");
		}
		fen.append(buf.length() == 0 ? "-" : buf.toString()).append(" ");
		
		if("-1".equals(fields.elementAt(10))) {
			fen.append("- ");
		} else {
			fen.append(FILES.charAt(Integer.parseInt((String) fields.elementAt(10))));
			fen.append("B".equals(fields.elementAt(9)) ? "3" : "6").append(" ");
		}
		fen.append(fields.elementAt(15)).append(" ");
		fen.append(fields.elementAt(26));
